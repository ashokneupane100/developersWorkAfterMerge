...
//     address?: string;
//     distance_m?: number;
//     emailStatus: { attempted: boolean; ok: boolean; error?: string };
//     smsStatus: { attempted: boolean; ok: boolean; error?: string };
//   }>;
// };
...
//                       <td className="p-2">{r.emailAddress || "-"}</td>
//                       <td className="p-2">{r.phoneNumber || "-"}</td>
//                       <td className="p-2">{r.address || "-"}</td>
//                       <td className="p-2 text-right">{r.distance_m ?? "-"}</td>
//                       <td className="p-2">
//                         {r.emailStatus.attempted ? (r.emailStatus.ok ? "✅ Sent" : `❌ ${r.emailStatus.error || "Failed"}`) : "—"}
//                       </td>
//                       <td className="p-2">
//                         {r.smsStatus.attempted ? (r.smsStatus.ok ? "✅ Sent" : `❌ ${r.smsStatus.error || "Failed"}`) : "—"}
//                       </td>
//                     </tr>
//                   ))}
//                 </tbody>
